...
describe('Game3', function () {
  ...
  it('should be a winner', async function () {
    ...
    const signer1_address = await signer1.getAddress();
    const signer2_address = await signer2.getAddress();
    const signer3_address = await signer3.getAddress();

    // TODO: win expects three arguments
    await game.win(signer1_address, signer2_address, signer3_address);
